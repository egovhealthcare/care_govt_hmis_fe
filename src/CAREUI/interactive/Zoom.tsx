...
export const ZoomControls = (props: { disabled?: boolean }) => {
  ...
  return (
    <div className="border-secondary-400 fixed right-8 bottom-8 flex flex-col items-center justify-center gap-1 rounded-full border bg-white p-0.5 shadow-lg md:flex-row-reverse md:gap-2">
      <Button
      ...
      <span className="text-secondary-800 text-sm font-semibold">
